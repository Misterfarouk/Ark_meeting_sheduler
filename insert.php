...
require_once('meetingscheduler.php');
    ...
    $name = $_POST['name'];
    $email = $_POST['email'];
    $staff_id = $_POST['staff_selection'];
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        // {
            $sql = "INSERT INTO bookings ( name, email, staff_id, meeting_topic, meeting_time)
            VALUES ( '$name', '$email' ,'$staff_id', '$meeting_topic', '$meeting_time')";
          ...
          $arr = array( 'name' => $nameErr, 'email' => $emailErr, 'staff_id' => $staff_selectionErr, 'meeting_topic' => $topic_selectionErr, 'meeting_time' => $meeting_timeErr, "status" => 400);
          http_response_code(400);
